...
<base href="<%=basePath%>">
      ...
      <link href="css/themecss/lightslider.css" rel="stylesheet">
    ...
    <div id="content" class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="product-view-inner clearfix">
           <div class="content-product-left  col-md-5 col-sm-6 col-xs-12">
            ...
            <div id="thumb-slider" class="thumb-vertical-outer">
                ...
                <ul class="thumb-vertical">
                  <c:forEach items="${item.images}" var="image" varStatus="status">
                      <li class="image-additional">
                          <a data-index="${status.index }" class="img thumbnail" data-image="${image }" title="${item.title }">
                              <img src="${image }" title="${item.title } " alt="加载失败" />
                          </a>
                      </li>
                   </c:forEach>  
              ...
              <div class="large-image  class-honizol" style="height: 320px">
               <div class="box-label">
               </div>
               <img class="product-image-zoom" height="100%" src="${item.images[0]}" data-zoom-image="${item.images[0]}" title="${item.title }" alt="加载失败">
              </div>
           </div>
           <div class="content-product-right col-md-7 col-sm-6 col-xs-12">
            ...
            <div class="box-review">
             <div class="rating">
              ...
              <c:forEach begin="1" end="${item.roleId}">
                 <span class="fa fa-stack"> <img alt="" src="image/star/iconpic-star-S.png"> </span>
                 </c:forEach>
                   <a class="reviews_button" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;">${item.roleId }星商家</a>
              </div> 
             </div>
            ...
            <div class="product-box-desc">
             ...
             <div class="model"><span>发布时间：</span><fmt:formatDate value="${item.updated }" pattern="yyyy-MM-dd HH:mm:ss"/> </div>
              <div class="model"><span>发布者：</span> ${item.username }</div>
              <div class="model"><span>商品编号: </span>${item.id }</div>
              <div class="stock"><span>邮费:</span> <i class="fa fa-check-square-o"></i>包邮</div>
             </div>
            </div>
            ...
            <div id="product">
             <div class="box-cart clearfix">
              <div class="form-group box-info-product">
                 ...
                 <div class="cart">
                  <input type="button" value="Add to Cart" class="addToCart btn btn-mega btn-lg " data-toggle="tooltip" title="" onclick="cart.add('${item.id}');" data-original-title="加入购物车">
                 </div>
              </div>
            ...
            <div class="producttab ">
             <div class="tabsslider  ">
              <ul class="nav nav-tabs font-sn">
                 <li class="active"><a data-toggle="tab" href="#tab-description">商品详情</a></li>
                 <li><a href="#tab-review" data-toggle="tab">用户评论</a></li>
              </ul>
              <div class="tab-content ">
                 <div class="tab-pane active" id="tab-description">
                  <div id="itemDesc" style="text-align: center;">
                  <script type="text/javascript">
                  var itemId='${item.id}';
                  setTimeout(function(){
                	  $.get("/item/desc/"+itemId+".html", function(data){
      					$("#itemDesc").append(data);
      				});
          		},1000);
                  </script>
                  </div>
                ...
                <script type="text/javascript">
                 ...
                 console.log(username);
                  setTimeout(function(){
                	  $.post("/user/userEvaluate/"+username+".action", function(data){
                		 var i;
                		 var k;
                		console.log(data);
      					for(i=0;i<data.length;i++){
      						var divstart = "<div ><h5>  匿名&nbsp;&nbsp;发表时间：<span >"+data[i].created+"</span>";
      						var s =' <span class="fa fa-stack"> <img alt="" src="image/star/iconpic-star-S.png"> </span>';
      						var star='&nbsp;&nbsp;&nbsp<span class="fa fa-stack"> <img alt="" src="image/star/iconpic-star-S.png"> </span>';
      						for(k=1;k<data[i].evaluatescore;k++){
      							star+=s;
      
      						}
      						
      						var divend='</h5> <span>'+data[i].evaluatemsg+'</span><hr> </div>';
      						$("#tab-review").append(divstart+star+divend);
      					}
      				});
          		 },2000);
                  </script>
      ...
      <div class="content-product-bottom bottom-product clearfix">
        <ul class="nav nav-tabs">
          <li class="active"><a data-toggle="tab" href="#product-related">看了还看 </a></li> 
          <li><a data-toggle="tab" href="#product-upsell">友情推荐</a></li>
        </ul>
        <div class="tab-content">
            ...
            <div class="clearfix module horizontal">
              <div class="products-category">
                <div class="category-slider-inner products-list yt-content-slider releate-products grid" data-rtl="no" data-autoplay="no" data-pagination="no" data-delay="4" data-speed="0.6" data-margin="30" data-items_column0="4" data-items_column1="3" data-items_column2="2" data-items_column3="2" data-items_column4="1" data-arrows="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                                            <c:forEach items="${ likeness}" var="item">
...
<script type="text/javascript" src="js/themejs/lightslider.js"></script>
<script type="text/javascript" src="js/themejs/cslide.js"></script>
