...
$(document).ready(function() {
	...
	/*items: [
		{"src": 'http://192.168.142.131/7bdfc56a-4194-4485-8049-8b738d81d189.jpg' },
		{"src": 'image/catalog/demo/product/travel/12.jpg' },
		{"src": 'image/catalog/demo/product/travel/12.jpg' },
	]*/
		var datas=[];
		$("#thumb-slider").find(".image-additional").each(function() {
			var data={};
			data["src"] = $(this).find("a").attr('data-image');
			datas.push(data);
		console.log($(this).find("a").attr('data-image'));
		});
		console.log(datas);
	//	return datas;
