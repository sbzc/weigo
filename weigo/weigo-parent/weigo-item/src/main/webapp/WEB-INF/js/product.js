...
//                }
    ...
    if (setImButton(G.sku), 1319 === G.cat[0] && 
    		$.ajax({url: "http://misc.360buyimg.com/product/js/2012/item.baby.js?ver=20140123",cache: !0,dataType:
    			"script",scriptCharset: "gb2312"}), jdSref && searchEngineSource) {
        var m = "&encode=utf-8";
