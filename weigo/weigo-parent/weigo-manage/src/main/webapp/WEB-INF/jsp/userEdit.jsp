...
<article class="page-container">
	<form class="form form-horizontal" id="adminForm" method="post" action="/user/update">
	<!-- 隐藏域，修改的时候根据id修改 -->
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="email" disabled class="input-text" value="${user.email}" placeholder="请输入邮箱" id="email" name="email">
		</div>
	</div>
	<div class="row cl">
