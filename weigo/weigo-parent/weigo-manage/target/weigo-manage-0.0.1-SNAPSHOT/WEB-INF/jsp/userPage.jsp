...
<div class="pd-30">
    <div id="toolbar" class="l">
	    	...
	    	<span>
	    	<a title="禁用" href="javascript:;" onclick="user_stop();" class="btn btn-danger radius"><i class="glyphicon glyphicon-download"></i> </a>
	    	</span>
	    	<span>
	    	<a title="启用" href="javascript:;" onclick="user_start();" class="btn btn-info radius"><i class="glyphicon glyphicon-upload"></i> </a>
	    	</span>
            <span>
		    	<a title="查看用户增加趋势"  href="javascript:;" onclick="showChat();" class="btn btn-info radius"><i  class="glyphicon glyphicon-stats"></i> </a>
		    	</span>
    </div>
